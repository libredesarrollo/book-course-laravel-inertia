            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-3">
                        ...
                        <Input class="w-full" type="date" placeholder="Date From" v-model="from" />
                        <Input class="w-full" @change="customSearch" type="date" placeholder="Date To"
                            v-model="to" />
                        ...
                        <div>
                            ...
                            <Button class="ml-3" @click="cleanFilter" variant="secondary">
                                Clear
                            </Button>
